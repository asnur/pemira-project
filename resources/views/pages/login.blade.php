                        ...
                        <div class="p-3">
                            <form name="login_form" action="{{ route('auth') }}" method="POST" class="av-invalid">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="nim" required placeholder="Masukkan Nim anda" id="nim" pattern="[0-9]{10}"
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <a href="/" class="btn btn-light shadow-sm border" style="color: #333">Kembali ke Halaman
                                    Utama</a>
