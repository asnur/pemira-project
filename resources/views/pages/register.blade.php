					...
					<div class="bg-white shadow">
						<div class="p-4">
							<div class="text-center mt-3">
								...
								<p class="text-muted mt-2">Masukkan Nim dan Email Aktif anda<br> untuk melakukan registrasi
									Ulang</p>
							</div>
								...
								<form name="register_form" method="POST" class="av-invalid">
									...
									<div class="mb-3">
										...
										<input name="nim" required type="text" pattern="[0-9]{10}"
											placeholder="Masukkan Nim anda" id="nim" class="form-control" />
									...
									<div class="mb-3">
										...
										<input name="email" required placeholder="Masukkan email kampus"
											pattern=".+@student.nurulfikri.ac.id" placeholder="Masukkan Email anda"
									...
									<div class="g-recaptcha" data-callback="imNotARobot"
										data-sitekey="6LejB0saAAAAAGHy5AbJxfzDq7Fh4S7LnARB0yO5"></div>
									<div class="d-grid mt-3">
										<input name="submit" value="Registrasi Ulang" type="submit"
											class="btn btn-primary btn-none" disabled>
									</div>
								</form>
								<div class="d-flex justify-content-between mt-3">
									<a href="/" class="btn btn-light shadow-sm border" style="color: #333">Kembali ke
										Halaman Utama</a>
