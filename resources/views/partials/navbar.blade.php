<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#ContentNavbar"
            aria-controls="ContentNavbar" aria-expanded="false" aria-label="Toggle navigation">
                ...
                @if (Auth::check())
                    <li class="nav-item mx-2 border border-2 rounded-pill px-2">
                        <a class="nav-link fw-bold" href="#"
                            onclick="document.getElementById('form-logout').submit()"><i class="fa fa-sign-out"></i>
                            Logout</a>
                    </li>
                @else
                    <li class="nav-item mx-2 border border-2 rounded-pill px-2">
